...
plt.plot([0], [0], 'o', ms=34, color='b', label='Ядро звезды')
nucleus, = plt.plot([], [], '-', color='b') #Анимируемый объект
particles, = plt.plot([], [], '-', color='r', lw=5, label='Внешняя оболочка')
